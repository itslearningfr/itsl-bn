...
// this is the content at the top left
	$catchbase_content['top_left'] 	= '<a href="http://www.l-educdenormandie.fr" alt="Portail <sup>ENT</sup>"><img src="'. get_template_directory_uri() . '/images/partenaires/educ.png" class="logos_partners"></a>';
// this is the content at the bottom right
	...
	$catchbase_content['top_right']	= '&nbsp;<a class="genericon_parent genericon genericon-key" target="_self" href="https://leducdenormandie.itslearning.com/elogin/autologin.aspx">se connecter</a>';
