...
// this is the content at the top left
	$catchbase_content['top_left'] 	= '<a href="http://www.l-educdenormandie.fr" alt="Portail <sup>ENT</sup>"><img src="'. get_template_directory_uri() . '/images/partenaires/educ.png"></a>';
